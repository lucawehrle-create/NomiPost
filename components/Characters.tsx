              ...
              <div className="grid lg:grid-cols-12">
                ...
                <div className="lg:col-span-5 min-w-0 relative">
                  ...
                  >
                    ...
                    {/* Body image */}
                    <div className="relative z-10 w-[60%] sm:w-[50%] lg:w-[65%] flex-1 min-h-0">
                      <Image
                    ...
                    {/* Name */}
                    <div className="relative z-20 text-center pb-6 sm:pb-8 lg:pb-10 pt-3">
                      <h3
                ...
                <div className="lg:col-span-7 min-w-0 flex flex-col">
                  <div className="p-7 sm:p-9 md:p-10 lg:px-14 lg:py-12 flex flex-col flex-1">
                    ...
                    <div className="mb-7 md:mb-8">
                      <p className="text-[0.95rem] md:text-base text-slate-700 leading-[1.75] text-pretty">
